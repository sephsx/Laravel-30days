      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          <div class="flex-shrink-0">
            <img class="h-8 w-8" src="/assets/img/Dev.png" alt="Your Company">
          </div>
            ...
            <div class="relative ml-3">
              <div>
                <button type="button" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="h-8 w-8 rounded-full" src="assets/img/Dev.png" alt="">
                </button>
              </div>
    ...
    <div class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          ...
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Joseph</div>
            <div class="text-sm font-medium leading-none text-gray-400">Joseph@example.com</div>
          </div>
